...
shell.execute("wget https://raw.githubusercontent.com/TNTCreep/OpenTismTech1/refs/heads/main/Cell-FS/colouredmod/cell-fs-scorchedtoast.lua " .. installPath .. "cell.lua")
